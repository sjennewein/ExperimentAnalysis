/*	StartStandard - initializes and starts the timeharp for aspherix
	
		DATA = StartStandard(EXPTIME, CFDZERO, CFDDISCR, SYNCLEVEL, OFFSET, RANGE) 
		This function needs to called first afterwards ReadStandard needs to be called to gather 
		the result.
*/
